...
from LoveG_Music.modules.play import generate_cover
from LoveG_Music.modules.play import arq
from LoveG_Music.modules.play import cb_admin_check
from LoveG_Music.modules.play import transcode
from LoveG_Music.modules.play import convert_seconds
from LoveG_Music.modules.play import time_to_seconds
from LoveG_Music.modules.play import changeImageSize
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @LoveG_Music to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/c1ea67d70015ec2582593.png"
