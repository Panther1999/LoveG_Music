...
from LoveG_Music.config import ARQ_API_KEY
from LoveG_Music.config import BOT_NAME as bn
from LoveG_Music.config import DURATION_LIMIT
from LoveG_Music.config import UPDATES_CHANNEL as updateschannel
from LoveG_Music.config import que
from LoveG_Music.function.admins import admins as a
from LoveG_Music.helpers.admins import get_administrators
from LoveG_Music.helpers.channelmusic import get_chat_id
from LoveG_Music.helpers.errors import DurationLimitError
from LoveG_Music.helpers.decorators import errors
from LoveG_Music.helpers.decorators import authorized_users_only
from LoveG_Music.helpers.filters import command
from LoveG_Music.helpers.filters import other_filters
from LoveG_Music.helpers.gets import get_file_name
from LoveG_Music.services.callsmusic import callsmusic
from LoveG_Music.services.callsmusic import client as USER
from LoveG_Music.services.converter.converter import convert
from LoveG_Music.services.downloaders import youtube
from LoveG_Music.services.queues import queues
...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nOr manually add assistant to your Group and try again manually request here @LoveG_Music with your group link</b>",
                    )
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/812f7119152abd47d92b1.png"
        ...
        try:
            ...
            await lel.edit(toxxt,reply_markup=koyboard,disable_web_page_preview=True)            # WHY PEOPLE ALWAYS LOVE PORN ?? (A point to think)
            return
        except:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add assistant to your Group and try again manually request here @hindigroup1326 with your group link</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @LoveG_Music to your Group and try again manually request here @LoveG_Support with your group link</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
